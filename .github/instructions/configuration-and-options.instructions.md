---
description: "Use when creating or modifying C# backend configuration in RecipeIQ. Enforces the Options pattern, startup validation, and secure handling of sensitive values through environment-based configuration sources."
name: RecipeIQ Configuration And Options Standards
applyTo:
  - "src/**/*.cs"
