---
description: "Use when creating or modifying documentation diagrams in RecipeIQ markdown files. Enforces Mermaid-only diagrams that are markdown-compatible and source-controlled as text."
name: RecipeIQ Mermaid Diagram Standards
applyTo:
  - ".docs/**/*.md"
  - ".org/**/*.md"
  - "README.md"
