---
description: "Use when creating or modifying C# backend services, controllers, or domain workflows in RecipeIQ. Enforces Microsoft.Extensions.Logging usage, environment-appropriate log levels, sensitive-data exclusions, and username masking rules."
name: RecipeIQ Logging And Sensitive Data Standards
applyTo:
  - "src/**/*.cs"
---
# Logging Standards
