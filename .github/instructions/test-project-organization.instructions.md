---
description: "Use when creating or modifying tests in RecipeIQ. Enforces a single development unit test project, namespace-aligned folder organization, and separation of development unit tests from QA integration tests."
name: RecipeIQ Test Project Organization Standards
applyTo:
  - "src/**/*.cs"
  - "src/**/*.csproj"
  - "tests/**/*.cs"
