...
│   ├── code-review/           # Code Review agent persona and context
...
| Code Review Agent | [.org/code-review/CLAUDE.md](.org/code-review/CLAUDE.md) | PR gate — coding standards, architectural compliance, requirements coverage, test coverage, CI pass |
...
- **Code Review Agent** is the final merge gate — reviews every PR for coding standards compliance, architectural correctness, requirements coverage, and adequate test coverage. Approves or returns PRs with structured, blocking/advisory findings before PM closes the issue.
...
| Work Item | Product Owner | UX Designer | Architect | PM | Backend | QA | Code Review | Platform | Security |
| --------- | ------------- | ----------- | --------- | -- | ------- | -- | ----------- | -------- | -------- |
| Roadmap priorities and scope | A/R | I | C | C | I | I | I | I | I |
| UI/UX design and component specs | C | A/R | C | I | C | I | I | I | I |
| Technical constraints and technology choice | C | I | A/R | I | C | C | C | C | C |
| Public interface contracts (pre-implementation) | I | C | A/R | C | C | C | I | I | C |
| Feature implementation in `src/` | I | I | C | I | A/R | C | I | I | C |
| Test strategy and verification in `tests/` | C | I | C | I | C | A/R | I | C | C |
| PR review — standards, architecture, requirements, coverage | I | I | C | I | C | C | A/R | I | C |
| CI/CD quality gates and release automation | I | I | C | C | I | C | I | A/R | C |
| Secrets and dependency security baseline | I | I | C | I | C | C | I | C | A/R |
