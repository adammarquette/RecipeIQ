---
description: "Use when creating or modifying C# backend code, ASP.NET endpoints, or gRPC contracts/services in __PROJECT_NAME__. Enforces XML documentation, OpenAPI/Swagger endpoint documentation, and clear gRPC docs."
name: __PROJECT_NAME__ API And Code Documentation Standards
applyTo:
  - "src/**/*.cs"
  - "tests/**/*.cs"
  - "**/*.proto"
