---
description: "Use when creating or modifying ASP.NET Web API code in __PROJECT_NAME__. Enforces FluentValidation for request validation and DI-based validator registration."
name: __PROJECT_NAME__ FluentValidation And DI Standards
applyTo:
  - "src/__ROOT_NAMESPACE__.Api/**/*.cs"
  - "src/__ROOT_NAMESPACE__.Core/**/*.cs"
---
