---
description: "Use when creating or modifying persistent data models, entities, schemas, or storage contracts in __PROJECT_NAME__. Requires a data dictionary with field name, type, and description, including nested or embedded JSON/subdocument fields."
name: __PROJECT_NAME__ Data Dictionary Standards
applyTo:
  - "src/**/*.cs"
  - ".docs/**/*.md"
  - "**/*.json"
