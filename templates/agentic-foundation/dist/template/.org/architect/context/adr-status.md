...
| ADR-004 | Introduce `__ROOT_NAMESPACE__.Data` for EF Core persistence | Accepted (Partially Implemented) | [adr-004-ef-core-data-layer.md](adr-004-ef-core-data-layer.md) | Data project present, migration in progress |
