...
- No new infrastructure concerns leak into `__ROOT_NAMESPACE__.Core`
- Controller-per-domain-concept pattern is maintained in `__ROOT_NAMESPACE__.Api`
